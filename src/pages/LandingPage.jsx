  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4">
        ...
        >
          {/* Card Container */}
          <div className="backdrop-blur-sm bg-white/50 p-6 sm:p-8 md:p-10 rounded-2xl border-2 border-slate-300 shadow-xl">
            {/* Date and Time */}
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              <div className="space-y-2">
                ...
                <div className="h-px w-16 sm:w-24 mx-auto bg-slate-500" />
              </div>
            </motion.div>
            ...
            >
              <motion.button
                ...
                className="group relative w-full bg-slate-400 text-white px-6 py-3 sm:px-8 sm:py-3 rounded-xl font-medium shadow-lg hover:bg-slate-600 transition-all duration-200"
              >
