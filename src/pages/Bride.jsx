        ...
        <div className="relative px-4 sm:px-8 py-8 sm:py-10 rounded-2xl border border-cyan-100/50">
          ...
          <div className="space-y-6 text-center">
            <div className="space-y-3">
              <div className="relative rounded-xl overflow-hidden shadow-xl border border-cyan-200">
                <img
                  src={photo}
                  alt="photo-mempelai"
                ...
                <div className="absolute bottom-3 left-1/2 -translate-x-1/2 bg-white/70 px-4 py-1 rounded-full">
                  <p className="text-cyan-800 font-serif italic text-lg">
                    {simpleName}
                  </p>
                </div>
              </div>
              ...
              {/* Full Name */}
              <h2 className="mt-6 text-xl text-cyan-500 font-semibold  font-serif">
                {fullName}
              </h2>
