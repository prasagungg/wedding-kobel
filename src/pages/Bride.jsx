  ...
  return (
    <>
      <section id="bride" className="mt-10 relative overflow-hidden">
        ...
        <div
          className="w-[100px] h-[100px] bg-cover absolute right-0 bottom-0"
          style={{ backgroundImage: `url(${flower})` }}
        ></div>

        <div
          className="w-[100px] h-[100px] bg-cover absolute left-0 bottom-0 -scale-x-100"
          style={{ backgroundImage: `url(${flower})` }}
        ></div>
